...
//CODE HERE
if (temperature >= && rain = true) {
  console.log("Make sure to wear a t-shirt and bring an umbrella!");
...
} else if (temperature >= && rain = false) {
  console.log("Make sure to wear a t-shirt!");
